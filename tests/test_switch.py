...
from custom_components.irtrans import async_setup_entry
from custom_components.irtrans.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch("custom_components.irtrans.IRTransApi.async_set_title") as title_func:
